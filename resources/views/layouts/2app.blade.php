            ...
            <div class="kt-aside__brand kt-grid__item " id="kt_aside_brand">
                <div class="kt-aside__brand-logo">
                    <a href="{{route('dashboard')}}" class="color-white fz-20">
                        ...
                        <span class="pl-4 space" style="font-size: 12px">سطلة الطاقة والموارد الطبيعية الفلسطينية</span>
                    </a>
                </div>
                    ...
                    <ul class="kt-menu__nav ">
                        ...
                        <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
                            data-ktmenu-submenu-toggle="hover"><a href="{{route('reports.index')}}"
                                ...
                                </span><span class="kt-menu__link-text">Daily Report</span></a>
                        </li>
                        <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
                            data-ktmenu-submenu-toggle="hover"><a href="{{route('reports.index')}}"
                                                                  class="kt-menu__link kt-menu__toggle"><span
                                    class="kt-menu__link-icon">
                                  <i class="flaticon-file-1"></i>
                                </span><span class="kt-menu__link-text">Events</span></a>
                        </li>
                    </ul>
                </div>
            </div>
